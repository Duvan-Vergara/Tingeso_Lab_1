...
public class OfficeHRMService {
   ...
   public int getAnnualSalary(UserEntity employee) {
      int annualSalary = 0;
   ...
   public int getSalaryBonus(UserEntity employee) {
      int salaryBonus = 0;
   ...
   public int getChildrenBonus(UserEntity employee) {
      int childrenBonus = 0;
   ...
   public int getExtraHoursBonus(UserEntity employee, int numExtraHours) {
